...
class DocumentAPI{
    ...
    public static function generate_doc_title($year, $type, $cours, $section_fac=null, $departement=null, $university=null, $stage=null): string{
        ...
        */
        /*
        1. vérifier si tous les cases sont complétés selon le type de document
        */
        /*
        2. Emmetre une erreur pour chaque cas
        */
        /*
        3. ecrire les données dans le titre selon l'exemple
        */
